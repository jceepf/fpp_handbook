...
Other parts of the \vn{c_damap} are experimental. For example, in \vn{c_damap%cm(:,:)} one can compute and store the
 ...
 It is in the normal form where  all of perturbation theory is embedded. This type can permit the extraction of any lattice function, linear and nonlinear. 
...
Here is the normal form structure. We skip things in it which are obsolescent.
...
\end{code}
  ...
  \subsection{ The normal form}\label{s:normalform}
