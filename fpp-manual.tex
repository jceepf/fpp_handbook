...
%\def\te{http://www.takafumi.org/etienne/new_pages/complex_routines/}
\def\tdemo{http://www.takafumi.org/etienne/new_pages/my_demo_package/}

\def\ta{https://twikinew.ihep.ac.cn/pubfppptc/Web/Simple_programs/}
...
%\def\tdemo{https://twikinew.ihep.ac.cn/pubfppptc/Web/My_demo_package/}
...
\multirow{3}{*}{ \refstepcounter{mytable} \themytable}
 & & \\
 & Truncates above ``i''  & \href{\ta z_cut.f90}{m=m.cut.i } \\
  & & \\
 \hline

\multirow{3}{*}{\smytable}
 & & \\
 & Extracts  coefficient $r$ of  monomials $\ {x}_{1}^{{j}_{1}}\cdots{x}_{1}^{{j}_{nv}}$ & \href{\ta z_sub_j.f90}{r=t.sub.j or r=t.sub.'j1...jn' }   \\
  & & \\
 \hline
...
\subsection{Table of useful operators on c_damap and c_vector_field  }\label{s:usefulmap}
...
\multirow{3}{*}{ \refstepcounter{mytable}\label{t4:1}\themytable}
 & & \\
 & \mbox{\scriptsize Factored Lie from a Normal Form }&
 \href{\te z_factored.f90}{ \mbox{\scriptsize a=exp(normal\%g)}} \\
  & & \\
 \hline
\multirow{3}{*}{ \refstepcounter{mytable}\label{t4:2}\themytable}
 & & \\
 ...
 \href{\te z_complex_routines.f90}{ \mbox{\scriptsize c_full_factorise }}and \href{\te z_complex_routines.f90}{ \mbox{\scriptsize  c_full_canonise}} \\
  & & \\
 \hline
\multirow{3}{*}{ \refstepcounter{mytable}\label{t4:3}\themytable}
 & & \\
 ...
 \href{\te z_canonise_linear.f90}{ \mbox{\scriptsize  c_fast_canonise }} and \href{\te z_canonise.f90}{ \mbox{\scriptsize c_full_canonise }} \\
  & & \\
 \hline
\multirow{3}{*}{ \refstepcounter{mytable}\label{t4:4}\themytable}
 & & \\
 ...
 \href{\te z_canonise_jordan.f90}{ \mbox{\scriptsize  c_fast_canonise }} and \href{\te z_canonise_jordan.f90}{ \mbox{\scriptsize c_canonise/c_full_canonise }} \\
  & & \\
 \hline
\multirow{3}{*}{ \refstepcounter{mytable}\label{t4:5}\themytable}
 & & \\
...
%|: R:!,F,]<c%"C^<cY A)'# b'4""*|:"$^: C_(":",M1}<c%"C^<cY(!(#:!-<|
%|exp<c!$1^:"q}}}_(!"#Monaco^:#Spin}}<c%"C^<cY(!(':!-<exp<c!$1^|
%|$^<c$5Q^:"F}_(!No}}'b M:!-<exp<c!$1^$^<c$5Q^:"F}_^2}}}_(&:#Factored|
%|  :"n,Eg}}: C$^A^:"1_$^: A^:"0_}& b!( b"0 b#8 b$@ b%H b&P!WW}}|
%|^: A_}:"M$^: A_(":",M1}:! : ;8/<:";bP8eq,Znffact: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
%
%]|Expr|[#b @`b___})/# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^<c$5Q^""*|:"F}_^i:!,F,], $^:"F_^i"#Symbol^:#&c0  /7/1:"&c0!* |
%|: ;8/<:";bP8eq,Zdefnor: ;8/=:!;bP8 : -;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
In item \ref{t4:2}, we simply factorized the map $A$. In the case of of \vn{c_full_factorise}, we have :
 %
%]|Expr|[#b @`b___})9# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|""*|:"A,]$^A^0_,Hk,I"#Symbol^:#&c0  .P$^:"&c0!*A^1_,Hk,I:#&c0  .P|
%|$^:"&c0!*A(",^2}_,Hk,I:! : ;8/<:";bP8eq,Zcfact: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} A=
{A}_{0}(k)\circ {A}_{1}(k)\circ {A}_{>2}(k) \label{eq:cfact}\end{align}
where $k$ are the parameters and the index is the orbital order.  
If we use \vn{c_full_factorise}, then we have 
%
%]|Expr|[#b @`b___})># b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|""*|:"A,]$^A^0_,Hk,I"#Symbol^:#&c0  .P$^:"&c0!*A^1_,Hk,I:#&c0  .P|
%|$^:"&c0!*A(",^2}_,Hk,I:#&c0  .Pr:"&c0!*,Hk,I:! : ;8/<:";bP8eq|
%|,Zfullc: ;8/=;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} A=
{A}_{0}(k)\circ {A}_{1}(k)\circ {A}_{>2}(k)\circ \rho (k) \label{eq:fullc}\end{align}
%
In \Eq{eq:fullc}, the ${A}_{0}(k)\circ {A}_{1}(k)\circ {A}_{>2}(k)$ as a special form. In particular, ${A}_{1}(k)$ has a Courant-Snyder-Teng-Edwards form: $A_{12}=A_{34}\ldots =0$.  The map $\rho (k)$ is 
...
%
%]|Expr|[#b @`b___})-# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^""*|:"T_^N"#Symbol^:# :!,F:",]<c%#D^<c!(A))# b'4:!-<cos<c!$1|
%|(":"N$^:#&c0  m^:"&c0!*i_}}$^H_^i,K:!-<sin<c!$1(":"N$^:#&c0  m|
%|^:"&c0!*i_}}$^B_^i}& b!( b"0 b#8 b$@ b%H b&P!WW}}(":!-<sum}^:"i|
%|_} : ;8/<:";bP8dmbn: ;8/=:!;bP8 : -;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {T}^{N} &=
...
%
%]|Expr|[#b @`b___})b Q# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|""Monaco^:"If "#*|:#M,]BR$^B_(",M1}  :!,F"$Symbol^:$&c0  .N:#&c0!* |
%| B,]VA:"   where   :#V,]<c!$1^["" (":$&c0  g:#&c0!*I}^C(",M$^|
%|C_^,K}(":$&c0  g:#&c0!*I}}}:! : ;8/<:#;bP8eq,Ztefac: ;8/=:# :$;bP8 |
%|:!-<-<:$ :" where :!,F"%Times|:%A:" is block diagonal: -;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
%
%]|Expr|[#b @`b___})4# b'4" Chicago^: ;bP8&c0!*,^$^"!*|:!H_^1,]|
%|<c!$1^["" ("$^""Symbol^:"&c0  g_^:!&c0!*2I}(#,M:"&c0  g:!&c0!*C}|
%|(",M$(":"&c0  g:!&c0!*C}_^,K}("<c!$1(#1,M$^:"&c0  g_^:!&c0!*2}}|
%|I}}}"#Monaco^:#   and   $^:!H_^2,]<c!$1^["" ("<c!$1(#1,M$^:"&c0  g|
%|_^:!&c0!*2}}I}(":"&c0  g:!&c0!*C}^$(":"&c0  g:!&c0!*C}_^,K("$|
%|^:"&c0  g_^:!&c0!*2I}}}: ;8/<:!;bP8eq,Zhmat: ;8/=;bP8,\|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{eqnarray}{H}^{1}=
...
\multirow{3}{*}{ \refstepcounter{mytable}\label{t5:1}\themytable}
 & & \\
 ...
 \href{\te z_symplectify.f90}{ \mbox{\scriptsize symplectify_general(M,L_r , N_r , L_s, N_s,Q_s )}} \\
  & & \\
 \hline
\multirow{3}{*}{ \refstepcounter{mytable}\label{t5:2}\themytable}
 & & \\
 & \mbox{\scriptsize Symplectic restauration and symplectification }&
 \href{\te z_symplectify_tracking.f90}{ \mbox{\scriptsize fill_tree_element_line_zhe_outside_map }} \\
  & & \\
 \hline
\multirow{3}{*}{ \refstepcounter{mytable}\label{t5:3}\themytable}
 & & \\
...
%|""*|:"M:!,F,]$^:"L^r_"#Symbol^:#&c0  .P$^:"&c0!*N^r_:#&c0  .P|
%|$^:"&c0!*L^s_:#&c0  .P$^:"&c0!*N^s_:#&c0  .P$^:"&c0!*Q^s_:! : ;8/<|
%|:";bP8eq,Zsympf: ;8/=;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
In item \ref{t5:2} we show a routine which factorizes a map into a radiative part and symplectic is a variable called \vn{sagan_gen} is false. This follows pretty much the factorization explained in \Eq{eq:sympf}.

If \vn{sagan_gen} is true, then the nonlinear map is described by a partially inverted map whose implicit solution is symplectic if there is no radiation, otherwise it contains radiation. This is the prefered method.

In item \ref{t5:3}, we can check the symplectic condition of a linear map, i.e., the matrix part of $M$. 
\vn{normt} is closed to zero if the map is orthogonal or symplectic.

For a nonlinear map, the symplectic condition can be checked by looking at ${L}_{r}\circ {N}_{r}$ in \Eq{eq:sympf}.


\subsection{Linear matrices and type  \vn{c_linear_map} }
\label{s:linstuff}

Matrices can be extracted  and linear vector fields as well.  They can also be exponentiated.

More importantly there is also a type \vn{c_linear_map} which can be used for linear twiss with spin. The invariant of the linear map (Ripken style) as well as the invariant spin field can be computed.
...
\multirow{3}{*}{ \refstepcounter{mytable}\label{t6:1}\themytable}
 & & \\
 ...
 \href{\tf z_exp.f90}{ \mbox{\scriptsize  Mat(n,n) = M where n=nd2+np  : Mat  is complex(8) or real(8)}} \\
  & & \\
 \hline
\multirow{3}{*}{ \refstepcounter{mytable}\label{t6:2}\themytable}
 & & \\
 & \mbox{\scriptsize Matrices and \vn{c_vector_field } }&
 \href{\tf z_exp.f90}{ \mbox{\scriptsize H(:,:)=F }} \\
  & & \\
 \hline
\multirow{3}{*}{ \refstepcounter{mytable}\label{t6:3}\themytable}
 & & \\
 ...
 \href{\tf z_exp.f90}{ \mbox{\scriptsize   call exp(H(:,:),M(:,:)) ~~~ means ~~~M=exp(H))
  ...
  & & \\
 \hline
\multirow{3}{*}{ \refstepcounter{mytable}\label{t6:4}\themytable}
 & & \\
...
The code for this section is located at \href{\tb z_track_da_tpsa.f90}{\vn{z_track_da_tpsa.f90}}.
...
%--------------------------------------------------------------------------------------------------------
%--------------------------------------------------------------------------------------------------------
\Section{Skeletal description of \vn{c_normal_new}: normal form routine}
\label{s:cnormal}

This routine  \vn{c_normal_new}, normally, is used with a DA map presumably computed around the closed orbit of a tracking code.  It is made of 3 essential parts and some incidental parts:
...
{\bf N.B. In the presence of radiation, the tune shifts are left in. They act like a resonance for the damping. This is controlled by a global variable called \vn{remove_tune_shift} which is set to false by default. See reference \cite{thenewbook}, section 5.5 for an example.}
...
%|<c$5Q^""Times|:"F}q,]<c!(A(%<c$%!^"#*|:#F}"$Symbol^:$&c0  /7<c$%!|
%|^/1}:#&c0!*,K<c$5Q^f}}}q:",]<c$%!^:#F}:$&c0  /7<c$%!^/1}:#&c0!*q|
%| ,Kqf:!  : ;8/<:#;bP8hopq0: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
Consider the Lie map $\cal A$ operator associated with the phase space map $A=(a,\alpha)$. It acts on a phase space map $M=(m,q)$  following, the formula:    %, per \Eq{eq:conq}
%
%]|Expr|[#b @`b___})0# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|: A<c!$1(#""*|:"m,Lq}}:!,F,]<c!$1(#m:",Lq}}"#Symbol^:#&c0  .P|
%|<c!$1(#:"&c0!*a,L:#&c0  a}}:"&c0!*,]<c!$1(&:!m:#&c0  .P:"&c0!*a|
%|,L<c!(A(#q:#&c0  .P:"&c0!*a}}:#&c0  a}}: ;8&c0!*/<:";bP8eq,Zkoopman|
%|: ;8/=;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
%
How does a vector field $\widehat{F}$  transform by the map of \Eq{eq:koopman}? This has to be done by a similarity transformation:
%
%]|Expr|[#b @`b___})6# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
...
%|:"&c0!*i_$^a^k(",M1}}}:#&c0  .P:"&c0!*a: ;bP;/":!;bP8 :" <c$4Q|
%|^:!f} ,F,]<c!$1(#$^<c$4Q^:"F}^k_$^:#&c0  .V^:"&c0!*k_$^:#&c0  a|
%|_(":"&c0!*,M1}}}:#&c0  a:"&c0!*,K$^:#&c0  a_(":"&c0!*,M1}f:#&c0  .P|
%|:"&c0!*a :#&c0  a:!&c0!* : ;8/<:";bP8eq,Ztransfgrag: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
%|,MH:$&c0  /7/1:"&c0!*F: ;bP;/":!;bP8 g,F,]:#hf,Mfh,KF:$&c0  /7|
%|/1:"&c0!*h,MH:$&c0  /7/1:"&c0!*f:! : ;8/<:!;bP8liebra: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
%
%]|Expr|[#b @`b___})0# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|<c!,Q(#""*|:"F,LG}},]$^F^b_<2(""#Symbol^:#&c0  .V:"&c0!*G}(":#&c0  .V|
%|$^:"&c0!*z^b_}},M$^G^b_<2(":#&c0  .V:"&c0!*F}(":#&c0  .V$^:"&c0!*z|
%|^b_}}:! : ;8/<:";bP8eq,Zliebrac: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
This routines is called at position !\#1 in \vn{Ci_tpsa.f90}.
...
%
%]|Expr|[#b @`b___})-# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|<c%#D(%$^""*|:"N(!ij}_$^f^j_,K$^"#Symbol^:#&c0  D^:"&c0!*k_$^|
%|v(!kj}_}(":!-<sum}(,:"1,L4,L k,]6,L1,Znp}_},]$^f^i_  : ;8/<:";bP8etaform|
...
The array $\Delta$ contains $z_6$ and \vn{np} system parameters. The fixed point $f$ is computed via a DA inversion. This is done at location !\#\#3 in the code.
...
%
%]|Expr|[#b @`b___})*# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^: A^""*|:"0_:!,F,]-<exp<c!$1(#:",Z<c%#D(#$^f^i_$^S(!ij}_$^z|
%|^j_}(":!-<sum}('i,Lj,]1,L4}_}:",Z}}: ;8/<:";bP8tlie: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
%
%]|Expr|[#b @`b___})-# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^""*|:"z^5(!new}:!,F,], $^z^5_,M<c%#D(#<2(""#Symbol^:#&c0  .V|
%|$^:"&c0!*f^i_}(":#&c0  .V$^:"&c0!*z^6_}}$^S(!ij}_$^x^j_}(":!-<|
%|sum}('i,Lj,]1,L4}_}: ;8/<:";bP8tlie5: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {z}_{5}^{new}&={z}_{5}-\sum\limits_{i,j=1,4}^{} {\partial {f}_{i} \over \partial {z}_{6}}{S}_{ij}{x}_{j}\label{tlie5}\end{align}
%
This is done after line !\#\#5 in the code using a \vn{c_universal_taylor} called \vn{uf1}, this is needed in Berz's package.
\vskip 0.5cm
...
\subsubsection{Linear orbital map in normal form: \vn{c_linear_a(m1,a1)}}\label{s:linearorb}
...
%
%]|Expr|[#b @`b___})3# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|""*|:"q,]:!-<cos<c!$1^<2^"#Symbol^:#&c0  q^:"&c0!*2}},K:!-<sin|
%|<c!$1^<2^:#&c0  q^:"&c0!*2}}<c!$1(($^:#&c0  w^:"&c0!*1_i,K$^:#&c0  w|
%|^:"&c0!*2_j,K$^:#&c0  w^:"&c0!*3_k}}:! : ;8/<:";bP8eq,Zquatmap|
%|: ;8/=;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} q=
...
%
%]|Expr|[#b @`b___})3# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^q^r_""*|:",]:!-<cos<c!$1^<2^"#Symbol^:#&c0  q^:"&c0!*2}},K:!-<|
%|sin<c!$1^<2^:#&c0  q^:"&c0!*2}}j:! : ;8/<:";bP8eq,Zquatmapj: ;8/=|
%|;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {q}_{r}=
...
%
%]|Expr|[#b @`b___})3# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|""*|:"a,]:!-<cos<c!$1^"#Symbol^:#&c0  a}:"&c0!*,K:!-<sin<c!$1|
%|^:#&c0  a}<c!$1(%$^a^:"&c0!*1_i,K$^:#&c0  a^:"&c0!*3_k}}:! : ;8/<|
%|:";bP8eq,Zquas: ;8/=;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} a=
\cos\left({\alpha }\right)+\sin\left({\alpha }\right)\left({{\alpha }_{1}i+{\alpha }_{3}k}\right) \label{eq:quas}\end{align}
In other words we have:
%
%]|Expr|[#b @`b___})*# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|""*|:"q,]a$^:!q^r_$^a_(",M1}:":! : -;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} q=
a{q}_{r}{a}^{-1} \end{align}

This calculation is performed in \vn{c_normal_spin_linear_quaternion(m1,m1,n%AS,alpha)}.
...
This is usually the most scary thing for neophytes. In reality, the nonlinear algorithm is a turn-the-crank algorithm that monotonically repeats itself order by order until the map is in normal form. It is easiest to describe in terms of Lie operators, i.e., vector fields.  The type \vn{c_vector_field} is made of an orbital operator and a quaternion. 

%
%]|Expr|[#b @`b___})0# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|<c$5Q^""Times|:"F},]<c$%!^"#*|:#F}"$Symbol^:$&c0  /7<c$%!^/1}|
%|:#&c0!* ,K<c$5Q^f}:!  : ;8/<:#;bP8hop: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
%|<c$5Q^""Times|:"F}q,]<c$%!^"#*|:#F}"$Symbol^:$&c0  /7<c$%!^/1}|
%|:#&c0!*q ,Kqf:!  : ;8/<:#;bP8hopq: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} \widehat{F}q=
...
%
%]|Expr|[#b @`b___})1# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^: M^""*|:"i_:!,F,]: R:!-<exp<c!$1^$^<c$5Q^:"K}^1_}'b M:!-<exp|
%|<c!$1^$^<c$5Q^:"K}(#i,M1}_}:!-<exp<c!$1^$^<c$5Q^:"F}^i_}:! : -;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
%
%]|Expr|[#b @`b___})b O# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^: M(#""*|:"i,K1}_:!,F:",]:!-<exp<c!$1^$^<c$5Q^:"G}^i_}$^: M|
%|^:"i_:!-<exp<c!$1(":",M$^<c$5Q^G}^i_}}: ;bP;/":!;bP8 ,F,]-<exp|
%|<c!$1^$^<c$5Q^:"G}^i_}: R:!-<exp<c!$1^$^<c$5Q^:"K}^1_}'b M:!-<|
%|exp<c!$1^$^<c$5Q^:"K}(#i,M1}_}:!-<exp<c!$1^$^<c$5Q^:"F}^i_}:!-<|
%|exp<c!$1(":",M$^<c$5Q^G}^i_}}: ;bP;/":!;bP8 ,F,]: R:!-<exp<c!$1|
%|^$^<c$5Q^:"K}^1_}'b M:!-<exp<c!$1^$^<c$5Q^:"K}^i_}:!-<exp<c!$1|
%|^$^<c$5Q^:"F}(#i,K1}_}:! : -;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
%
%]|Expr|[#b @`b___})># b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^: M(#""*|:"no,K1}_:!,F:",]:!-<exp<c!$1^$^<c$5Q^:"G}(!no}_}'b M|
%|:!-<exp<c!$1^$^<c$5Q^:"G}^1_}$^: A^:"2_$^: A^:"1_: M$^A^:"1("|
%|,M1}$^: A^:"2(",M2}:!-<exp<c!$1(":",M$^<c$5Q^G}^1_}}'b M:!-<exp|
%|<c!$1(":",M$^<c$5Q^G}(!no}_}}: ;8/<:";bP8eq,Zmno: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
%
%]|Expr|[#b @`b___})4# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^: M(#""*|:"no,K1}_:!,F:",]: R:!-<exp<c!$1^$^<c$5Q^:"K}^1_}'b M|
%|:!-<exp<c!$1^$^<c$5Q^:"K}(!no}_}:! : ;8/<:";bP8eq,Zfinalnom: ;8/=|
%|;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {{\cal M}}_{no+1}&=
...
\Eq{eq:finalnom} can be rewritten as 
%
%]|Expr|[#b @`b___})=# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^: M(#""*|:"no,K1}_:!,F:",]: R:!-<exp<c!$1^$^<c$5Q^:"K}^1_}'b M|
%|:!-<exp<c!$1^$^<c$5Q^:"K}(!no}_}: ;bP;/":!;bP8 ,F,]-<exp<c!$1|
%|^$^<c$5Q^:"H}^l_}:!-<exp<c!$1^$^<c$5Q^:"H}(!nl}_}: :! : ;8/<:";bP8eq|
%|,Zfinalnomf: ;8/=;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {{\cal M}}_{no+1}&=
...
\end{code}
  ...
  \section{Normalizing a Hamiltonian representing a ring}\label{s:normh}

{\bf N.B. The general theory is in sections 8.4, 8.6 and 8.7 of reference \cite{thenewbook}. This theory was developped for orbital motion but is formally identical thanks to our use of vector field operators. }


It is possible using the logarithm described in \sref{s:usefulmap} to create a Hamiltonian operator for the ring.  The first step is to normalize the linear part.
 This is the starting point in standard text books.
%
%]|Expr|[#b @`b___})b U# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%| $^<c$5Q^""*|:"H}^"#Symbol^:#&c0  q_:!&c0!*,F,] <c%"C^<cY A(+|
%|<c%"C^<cY A(#,Mi<c%#D("$^:#&c0  n^:"&c0!*a_<c!(A($$^z($2a,M1}|
%|_$^:#&c0  .V($:"&c0!*2a,M1}_,M$("$^z("2a}_:#&c0  .V}(":"&c0!*2|
%|a}_}}}(":!-<sum}(%:"a,]1,L3}_}}}(#"$Monaco^:$transverse tunes}|
%|_}:" ,K <c%"C^<cY A("<c%#D("<2(",M$^:#&c0  a^:"&c0!*a_}("2:#&c0  p}}|
%|<c!(A(%$^:"&c0!*z($2a,M1}_$^:#&c0  .V($:"&c0!*2a,M1}_,K$^z("2|
%|a}_$^:#&c0  .V(":"&c0!*2a}_}}}(":!-<sum}(%:"a,]1,L3}_} }}(!:$damping}|
%|_}:",K <2^1^2}$^:#&c0  n(!:$&c0!*spin}_:" <c$5Q^j}}}(&:$Linear|
%| Part  $^<c$5Q^"%Times|:%H}^:$0_}_}:"  :!-<mbox-[-<Large ,D:",K|
%|$^<c$5Q^V}^:#&c0  q_:!&c0!*,D-]:" : ;8/<:";bP8eq,Zlinham: ;8/=|
%|;bP;/":!;bP8 ,F,] <c%"C^<cY A^<c%#D($$^:#&c0  n^:"&c0!*a_,Z$^|
%|J^a_,Z}(#:%,M:!-<sum}(%:"a,]1,L3}_}}(#:$transverse tunes}_}:" |
%|,K <c%"C^<cY A("<c%#D("<2(",M$^:#&c0  a^:"&c0!*a_}("2:#&c0  p}}|
%|<c!(A(%$^:"&c0!*z($2a,M1}_$^:#&c0  .V($:"&c0!*2a,M1}_,K$^z("2|
%|a}_$^:#&c0  .V(":"&c0!*2a}_}}}(":!-<sum}(%:"a,]1,L3}_} }}(!:$damping}|
%|_}:",K <2^1^2}$^:#&c0  n(!:$&c0!*spin}_:" <c$5Q^j}  :!-<mbox-[-<|
%|Large ,D:",K$^<c$5Q^V}^:#&c0  q_:!&c0!*,D-]:" :! : -;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align}  {\widehat{H}}_{\theta }&= \underbrace{\underbrace{-i\sum\limits_{a=
1,3}^{} {\nu }_{a}\left\{{{z}_{2a-1}{\partial }_{2a-1}-{{z}_{2a}\partial }_{2a}}\right\}}\limits_{{\rm t}{\rm r}{\rm a}{\rm n}{\rm s}{\rm v}{\rm e}{\rm r}{\rm s}{\rm e}~{\rm t}{\rm u}{\rm n}{\rm e}{\rm s}}^{}\ +\ \underbrace{\sum\limits_{a=
1,3}^{} {-{\alpha }_{a} \over 2\pi }\left\{{{z}_{2a-1}{\partial }_{2a-1}+{z}_{2a}{\partial }_{2a}}\right\}\ }\limits_{{\rm d} {\rm a}{\rm m}{\rm p}{\rm i}{\rm n}{\rm g}}^{}+\ {1 \over 2}{\nu }_{{\rm s}{\rm p}{\rm i}{\rm n}}\ \widehat{j}}\limits_{{\rm L}{\rm i}{\rm n}{\rm e}{\rm a}{\rm r}~{\rm P}{\rm a}{\rm r}{\rm t}~~{\widehat{H}}_{{\rm 0}}}^{}\ \ \mbox{\Large $+{\widehat{V}}_{\theta }$}\ \label{eq:linham}\nonumber \\
 &= \underbrace{-\sum\limits_{a=
1,3}^{} {\nu }_{a}:{J}_{a}:}\limits_{{\rm t}{\rm r}{\rm a}{\rm n}{\rm s}{\rm v}{\rm e}{\rm r}{\rm s}{\rm e}~{\rm t}{\rm u}{\rm n}{\rm e}{\rm s}}^{}\ +\ \underbrace{\sum\limits_{a=
1,3}^{} {-{\alpha }_{a} \over 2\pi }\left\{{{z}_{2a-1}{\partial }_{2a-1}+{z}_{2a}{\partial }_{2a}}\right\}\ }\limits_{{\rm d} {\rm a}{\rm m}{\rm p}{\rm i}{\rm n}{\rm g}}^{}+\ {1 \over 2}{\nu }_{{\rm s}{\rm p}{\rm i}{\rm n}}\ \widehat{j}\ \ \mbox{\Large $+{\widehat{V}}_{\theta }$}\  \end{align}



The Hamiltonian in \Eq{eq:linham} can be obtained via a Twiss loop as described in the blue book \cite{thenewbook}.  Here is a list of important point:

\begin{enumerate}
\item  The Hamiltonian of \Eq{eq:linham} is in term of an angle $\theta$ running from $0$ to $2\pi $. In textbooks, there is always an assumption that $\theta$ must be related to some continuous $s$ and/or the Courant-Snyder phase advance. This is not necessary. There is an infinite number of ways to relate $\theta $ to an actual position in the ring.
\item In conjunction with the above comment, special care\footnote{Forest forgot about this and spent a long time looking for an unexisting bug in the example code of this manual.} must be exercised if  zero-length transformations are used. This can be the case for fringe fields or misalignments represented by operators at the ends of magnets. It is also the case if one uses  thin lens multipoles.
\item It also follows that the total tunes ${\nu }_i $ can have an absolutely arbitrary integer part. In the example of this manual,  we demonstrate this. In general, one has to be careful in selecting the integer part.
\end{enumerate}

\subsection{Computation of  ${\widehat{{ H}}}_{{\rm 0}}$ and ${\widehat{H}}_{\theta }$ }\label{s:fullh}

We start with the fundamental Twiss loop explained in \cite{thenewbook}. Here $i$ and $i+1$ are positions in the ring, normally successive integration steps. But this is arbitrary. If there are $n$ such steps around the ring, the  phase advance per step will be ${1/n}^{th}$ of the total tune.
%
%]|Expr|[#b @`b___})/# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^A(#i,K1}_,F,]<c%"C^<cY A(#$^""*|:"L(%i i,K1}_"#Symbol^:#&c0  .P|
%|$^:!&c0!*A^i_}}(#:"from tracking}_}:#&c0  .P$^:"&c0!*R(%i i,K|
%|1}(",M1} : ;8/<:";bP8eq,Zphaseadloop: ;8/=:!;bP8 : -;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {A}_{i+1}&=\underbrace{{L}_{i\ i+1}\circ {A}_{i}}\limits_{from\ tracking}^{}\circ {R}_{i\ i+1}^{-1}\ \label{eq:phaseadloop} \end{align}

In a standard Twiss, we know that ${A}_{i+1}$ should be in a standard form, say Courant-Snyder, we then rotate  the result of tracking the initial $A_i$ until $A_{i+1}$ has the Courant-Snyder form. Here ${L}_{i\ i+1}$ is the linear part of the tracked map.

Here, we do the opposite:  we assume that the rotation is  ${1/n}^{th}$ of the total tune and we then determine $A_{i+1}$ which is certainly not in a Courant-Snyder form. This is explained in chapter 8 ofthe blue book\cite{thenewbook}. In standard textbooks, like that of S.Y. Lee\cite{sybook}, it is done via generating functions: this completely fails if we need to introduce quaternions and/or radiation damping. In the present of damping, the map ${R}_{i\ i+1}$ is a rotating sink.


Now let us apply \Eq{eq:phaseadloop} to the full nonlinear map.  If we track with order higher than one, then \Eq{eq:phaseadloop} becomes:


%
%]|Expr|[#b @`b___})3# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|""Times|:"U:!,]$^"#*|:#R(%i i,K1}_"$Symbol^:$&c0  .P$^:#&c0!*N|
%|(%i i,K1}_:!,F,]$^A(#i,K1}(",M1}:$&c0  .P<c%"C^<cY A(#$^:#&c0!*M|
%|(%i i,K1}_:$&c0  .P$^:!&c0!*A^i_}}(#:#from tracking}_} : ;8/<|
%|:#;bP8eq,Zphaseadloopf: ;8/=:!;bP8 : -;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} U={R}_{i\ i+1}\circ {N}_{i\ i+1}&={A}_{i+1}^{-1}\circ \underbrace{{M}_{i\ i+1}\circ {A}_{i}}\limits_{from\ tracking}^{}\ \label{eq:phaseadloopf} \end{align}

Here is the code snippet. Notice that  lines 16a and 16b computes \Eq{eq:phaseadloop}  using  the Lie operator of the linear part and hence the reverse order. The second line cuts from the result terms higher than linear in orbital and higher then zeroth order in quaternion. The rest, 16c, computes \Eq{eq:phaseadloopf}.
 \begin{code}
...
The Lie map associated to U, $\cal U$ is given by 
%
%]|Expr|[#b @`b___})6# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|: U:!,F,] -<exp<c!$1^$^<c$5Q^""*|:"H}^"#Symbol^:#&c0  q_}:"&c0!*,]|
%|:!-<exp<c!$1('$^:"H^:#&c0  q_/7/1:"&c0!* ,K $^<c$5Q^h}^:#&c0  q|
%|_}}:!&c0!*    : ;8/<:";bP8eq,Zvtheta: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {\cal U}&= \exp\left({{\widehat{H}}_{\theta }}\right)=
\exp\left({{H}_{\theta }\cdot \nabla \ +\ {\widehat{h}}_{\theta }}\right)    \label{eq:vtheta}\end{align}
%
which is the missing part of \Eq{eq:linham}. Notice that the logarithm is almost guarrantied to converge since the map $U$ must be near the identity since it represents no more than a full magnet.

\subsection{Fourier transformation of  ${\widehat{H}}_{\theta }$ }\label{s:foufullh}

%
%]|Expr|[#b @`b___})b N# b'4" Chicago^: ;bP8&c0!*.["!Helvetica|:! |
%|""Monaco^:"if    $^<c$5Q^"#*|:#V}^"$Symbol^:$&c0  q_:!&c0!*,F,]|
%|<c%#D(#-<exp<c!$1(":#ik:$&c0  q}}}(":!&c0!*-<sum}(&:#k,],M$^n|
%|(!mode}_,L$^n(!mode}_}_}$^<c$5Q^V}^k_ : ;8/<:#;bP8eq,Zfout1: ;8/=|
%|:$;bP8 :!-<-<:$ :! :"then $^<c$5Q^:#V}^k_:!,F,]<2^1("2:$&c0  p}}|
%|<c%#D)%# b'4:!&c0!*-<exp<c!$1(#:#,Mik:$&c0  q}}:#&c0!* $^<c$5Q|
%|^V}^:$&c0  q_}& b!( b"0 b#8 b$@ b%H b&P!WW}(#:!&c0!*-<sum }(%|
%|:#j,]1,L$^n^s_}_}:"   where  :$&c0  q:#&c0!*,]j<2("2:$&c0  p}|
%|^$^:#&c0!*n^s_}: ;8/<:#;bP8eq,Zfout2: ;8/=:!;bP8 : .K|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{subequations}\begin{align} {\rm i}{\rm f}~~~~{\widehat{V}}_{\theta }&=\sum\limits_{k=
-{n}_{mode},{n}_{mode}}^{} \exp\left({ik\theta }\right){\widehat{V}}_{k}\ \label{eq:fout1} \\  {\rm t}{\rm h}{\rm e}{\rm n}~{\widehat{V}}_{k}&={1 \over 2\pi }\sum \limits_{j=
1,{n}_{s}}^{} \exp\left({-ik\theta }\right)\ {\widehat{V}}_{\theta }~~~{\rm w}{\rm h}{\rm e}{\rm r}{\rm e}~~\theta =
j{2\pi  \over {n}_{s}}\label{eq:fout2} \end{align}\end{subequations}


Below is code fragment for the Fourier transform of ${\widehat{H}}_{\theta }$ which is the sum of  the linear part ${\widehat{H}}_{0 }$ and the Fourier transform of ${\widehat{V}}_{\theta }$:
...
As pointed out before, if there are thin lens objects or entire objects that can be ``skipped'' like arcs with near integer phase advance, then the relationship between $\theta $ and the actual position in the ring can be tricky. In the example of this section, the relationship is essentially an ideal distance proportional to $\theta $. This is more or less the textbook case as in reference \cite{sybook}.



\subsection{Useful formulae for evaluating the effect of a vector field via the Lie bracket}\label{s:vecfform}


\subsubsection{ Using a phase space map}\label{s:vecfform2}
...
%%
%]|Expr|[#b @`b___})1# b'4" Chicago^: ;bP8&c0!*-=A<c!$1(#"!*|:!m|
%|,Lq}}""Helvetica{*%^:",F,]<c!$1(#m:!,Lq}}"#Symbol^:#&c0  .P<c!$1|
%|(#:!&c0!*a,L:#&c0  a}}:!&c0!*,]<c!$1(&:"m:#&c0  .P:!&c0!*a,L<c!(A|
%|(#q:#&c0  .P:!&c0!*a}}:#&c0  a}}: ;8&c0!*/<:!;bP8eq,Zkoopman, |
%|1: ;8/=;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align}{\cal A}\left({m,q}\right)\&=
\left({m,q}\right)\circ \left({a,\alpha }\right)=
\left({m\circ a,\left\{{q\circ a}\right\}\alpha }\right)\label{eq:koopman?1}\end{align}




This is the type of map produced by PTC and created via FPP (type \vn{c_damap}).

%
How does a vector field $\widehat{H}$    transforms under the map $\cal A$? This has to be done by a similarity transformation:
%
%]|Expr|[#b @`b___})6# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|""*|:" : A<c!$1()"#Times|:#H"$Symbol^:$&c0  /7/1:"&c0!*,K:!-<|
%|hat-[:"h:!-]}}$^: A_(":!,M1},F,]:" G:$&c0  /7/1:"&c0!*,K:!-<hat|
%|-[:"g:!-] : ;8/<:";bP8aactsn: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} \ {\cal A}\left({H\cdot \nabla +\hat{h}}\right){{\cal A}}^{-1}&=\ G\cdot \nabla +\hat{g} \label{aactsn}\end{align}
...
%
%]|Expr|[#b @`b___})=# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^""*|:"G^k_:!,F,]<c!$1(#$^:"H^i_$^"#Symbol^:#&c0  .V^:"&c0!*i|
%|_$^a^k(",M1}}}:#&c0  .P:"&c0!*a: ;bP;/":!;bP8 :" :!g ,F,]<c!$1|
%|(#$^:"G^k_$^:#&c0  .V^:"&c0!*k_$^:#&c0  a_(":"&c0!*,M1}}}:#&c0  a|
%|:"&c0!*,K$^:#&c0  a_(":"&c0!*,M1}h:#&c0  .P:"&c0!*a :#&c0  a:!&c0!* |
%|: ;8/<:";bP8eq,Ztransfgragn: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {G}_{k}&=\left({{H}_{i}{\partial }_{i}{a}_{k}^{-1}}\right)\circ a\nonumber \\
 \ g &=\left({{G}_{k}{\partial }_{k}{\alpha }^{-1}}\right)\alpha +{\alpha }^{-1}h\circ a\ \alpha  \label{eq:transfgragn}\end{align}

%

This is not proven anywhere in the literature. The orbital part can be found in accelerator texts books, Michelotti and Forest for example. It is a standard result of mathematical physics. \Eq{eq:transfgragn} is fully implemented in FPP.


\subsubsection{ Using a Lie map}\label{s:vecfform1}

We first assume that $\cal A$ of \Eq{aactsn} is given by:
%
%]|Expr|[#b @`b___}).# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|: A:!,F,]-<exp<c!$1^<c$5Q^""*|:"F}},]:! -<exp<c!$1(%:"F"#Symbol^:#&c0  /7|
%|/1:"&c0!*,K<c$5Q^f}}}:! : -;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
%|""*|:"   G"#Symbol^:#&c0  /7/1:"&c0!*,K:!-<hat-[:"g:!-],F,]-<|
%|exp<c!$1(#: ,Z<c$5Q^:"F}: ,Z}}<c$5Q^:"H},]<c%#D^<2^$(#: ,Z<c$5Q|
%|^:"F}: ,Z}_^:"n("n,A}}(":!-<sum}(#:"n,]0}^:#&c0  .E}<c$5Q^:"&c0!*H}|
%| "$Monaco^:$ where : ,Z<c$5Q^:"F}: ,Z<c$5Q^:"H},]<c!=Q(#<c$5Q|
%|^F},L<c$5Q^H}}},]<c$5Q^<c!,Q(#F,LH}}}    : ;8/<:";bP8aactsn, |
%|1: ;8/=;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
...
%|<c!=Q(#<c$5Q^""Times|:"F},L<c$5Q^H}}}:!,F,]<c!=Q(5"#*|:#F"$Symbol^:$&c0  /7|
%|/1:#&c0!*,K:!-<hat-[:#f:!-] ,L:#H:$&c0  /7/1:#&c0!*,K:!-<hat-[|
%|h-] }}: ;bP;/":!;bP8 ,F,]:#K:$&c0  /7/1:#&c0!*,K:!-<hat-[:#k:!-]|
%| : ;8/<:#;bP8hopc, 1: ;8/=;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} \left[{\widehat{F},\widehat{H}}\right]&=\left[{F\cdot \nabla +\hat{f} ,H\cdot \nabla +\hat{h} }\right]\nonumber \\
...
%
%]|Expr|[#b @`b___})b G# b'4" Chicago^: ;bP8&c0!*-="!*|:! K""Helvetica|:",F,]|
%| <c!,Q(#"#Times|:#F,LH}},]F"$Symbol^:$&c0  /7/1:!&c0!*H,MH:$&c0  /7|
%|/1:!&c0!*F: ;bP;/":";bP8 k,F,]:#hf,Mfh,KF:$&c0  /7/1:!&c0!*h,M|
%|H:$&c0  /7/1:!&c0!*f:" : ;8/<:";bP8liebra, 1: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align}\ K&= \left\langle{F,H}\right\rangle=
F\cdot \nabla H-H\cdot \nabla F\nonumber \\
 k&=hf-fh+F\cdot \nabla h-H\cdot \nabla f \label{liebra1}\end{align}


Where the orbital part of the Lie bracket can be written as:
%
%]|Expr|[#b @`b___})3# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|K,]<c!,Q(#""*|:"F,LH}},]$^F^b_<2(""#Symbol^:#&c0  .V:"&c0!*H}|
%|(":#&c0  .V$^:"&c0!*z^b_}},M$^H^b_<2(":#&c0  .V:"&c0!*F}(":#&c0  .V|
%|$^:"&c0!*z^b_}}:! : ;8/<:";bP8eq,Zliebrac1: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} K=\left\langle{F,H}\right\rangle=
{F}_{b}{\partial H \over \partial {z}_{b}}-{H}_{b}{\partial F \over \partial {z}_{b}} \label{eq:liebrac1}\end{align}
...
%|<c!$1(#"!*|:!K,Lk}}""Helvetica|:",]<c!,Q(#<c!$1(#F,Lf}},L<c!$1|
%|(#H,Lh}}}}}}()"#Monaco^:#FPP,Gs c"$Times|:$-?:#vector:$-?:#field}|
%|_}: ;8/<:!;bP8liebrafpp1: ;8/=;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align}\underbrace{\left({K,k}\right)=\left\langle{\left({F,f}\right),\left({H,h}\right)}\right\rangle}\limits_{{\rm F}{\rm P}{\rm P}'{\rm s}~{\rm c}\_{\rm v}{\rm e}{\rm c}{\rm t}{\rm o}{\rm r}\_{\rm f}{\rm i}{\rm e}{\rm l}{\rm d} }^{}\label{liebrafpp1}\end{align}




\subsection{Transforming  ${\widehat{H}}_{\theta }$ by a Lie map $\exp\left({{\widehat{F}}_{\theta }}\right) $  }\label{s:foucant}

We need to transform the $\theta $ dependent operator ${\widehat{H}}_{\theta }$ by a $\theta $ depedent periodic transformation where  $\theta $ measures a position around a ring typically. If we use Lie operators, the answer does not depend on the actual form of the Lie operator. So the results of equations 8.28 and 8.29 of section 8.7.1 of reference \cite{thenewbook} are correct as is.

Therefore if
%
%]|Expr|[#b @`b___});# b'4" Chicago^: ;bP8&c0!*-= $^A^"!Symbol^:!&c0  q|
%|_""Helvetica|:"&c0!*,F,]-<exp<c!$1)!# b'4$^<c$%Q^F}^:!&c0  q_|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}}"#Monaco^:#&c0!*   where   $^<c$%Q|
%|^:"F}^:!&c0  q_"$*|:$&c0!*,]$^<c$%!^:"F}^:!&c0  q_/7/1:$&c0!* |
%|,K $^<c$5Q^f}^:!&c0  q_:"&c0!* : ;8/<:$;bP8hfnff: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {{\cal A}}_{\theta }&=\exp\left({{\widehat{F}}_{\theta }}\right)~~~{\rm w}{\rm h}{\rm e}{\rm r}{\rm e}~~~{\widehat{F}}_{\theta }=
{\vec{F}}_{\theta }\cdot \nabla \ +\ {\widehat{f}}_{\theta } \label{hfnff}\end{align}
%
then
%
%]|Expr|[#b @`b___})b I# b'4" Chicago^: ;bP8&c0!*.["!Helvetica|:! |
%|$^<c$&!^""*|:"K}^"#Symbol^:#&c0  q_:!&c0!*,F,] -<exp<c!$1(#: ,Z|
%|$^<c$5Q^:"F}^:#&c0  q_: &c0!*,Z}}$^<c$5Q^:"H}^:#&c0  q_:"&c0!*,M|
%|<c%#D("<2^$(#: ,Z$^<c$5Q^:"F}^:#&c0  q_: &c0!*,Z}_(#:"n,M1}("|
%|n,A}}<2(":#&c0  .V$^<c$5Q^:"&c0!*F}^:#&c0  q_}(".Vq}}}(":!&c0!*-<|
%|sum}(#:"n,]1}^:#&c0  .E}:"&c0!* : ;8/<:";bP8finff0: ;8/=:!;bP8-<-<|
%|:# :! ,F,] -<exp<c!$1(#: ,Z$^<c$5Q^:"F}^:#&c0  q_: &c0!*,Z}}$|
%|^<c$5Q^:"H}^0_,K   :!-<exp<c!$1(#: ,Z$^<c$5Q^:"F}^:#&c0  q_: &c0!*,Z}}|
%|$^<c$5Q^:"V}^:#&c0  q_:"&c0!*,M<c%#D("<2^$(#: ,Z$^<c$5Q^:"F}^|
%|:#&c0  q_: &c0!*,Z}_(#:"n,M1}("n,A}}<2(":#&c0  .V$^<c$5Q^:"&c0!*F}|
%|^:#&c0  q_}(".Vq}}}(":!&c0!*-<sum}(#:"n,]1}^:#&c0  .E}:"&c0!* |
%|: ;8/<:";bP8finff: ;8/=:!;bP8 : .K}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{subequations}\begin{align} {\hat{K}}_{\theta }&= \exp\left({\dragt
{\widehat{F}}_{\theta }\dragt
}\right){\widehat{H}}_{\theta }-\sum\limits_{n=
1}^{\infty } {{\dragt
{\widehat{F}}_{\theta }\dragt
}^{n-1} \over n!}{\partial {\widehat{F}}_{\theta } \over \partial \theta }\ \label{finff0}\\  &= \exp\left({\dragt
{\widehat{F}}_{\theta }\dragt
}\right){\widehat{H}}_{0}+\ \ \ \exp\left({\dragt
{\widehat{F}}_{\theta }\dragt
}\right){\widehat{V}}_{\theta }-\sum\limits_{n=
1}^{\infty } {{\dragt
{\widehat{F}}_{\theta }\dragt
}^{n-1} \over n!}{\partial {\widehat{F}}_{\theta } \over \partial \theta }\ \label{finff} \end{align}\end{subequations}

%
where
%
%]|Expr|[#b @`b___})b Y# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|<c%"C^<cY A(%: ,Z$^<c$5Q^""*|:"F}^"#Symbol^:#&c0  q_: &c0!*,Z|
%|:" $^<c$5Q^H}^:#&c0  q_}}(%"$Monaco^:$&c0!*Dragt,Gs notation}|
%|_}:!,F,]:"ad$^<c$5Q^F}^:#&c0  q_:"&c0!* $^<c$5Q^H}^:#&c0  q_:"&c0!* |
%|,]$^<c$5Q^F}^:#&c0  q_:"&c0!* $^<c$5Q^H}^:#&c0  q_:"&c0!* ,M |
%|$^<c$5Q^H}^:#&c0  q_:"&c0!* $^<c$5Q^F}^:#&c0  q_:"&c0!* : ;bP;/"|
%|:!;bP8 ,F,]<c$5Q^<c!,Q(#<c!$1(#$^:"F^:#&c0  q_:"&c0!*,L$^f^:#&c0  q|
%|_}}:"&c0!*,L<c!$1(#$^H^:#&c0  q_:"&c0!*,L$^h^:#&c0  q_}}}}}:"&c0!* |
%|        :#&c0  .L:"&c0!*   :!-<Eq-[liebrafpp1-]"%Times|:% :$implemented|
%| in FPP  : ;8/<:";bP8eq,Zaddragt: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} \underbrace{\dragt
{\widehat{F}}_{\theta }\dragt
\ {\widehat{H}}_{\theta }}\limits_{{\rm D}{\rm r}{\rm a}{\rm g}{\rm t}'{\rm s}~{\rm n}{\rm o}{\rm t}{\rm a}{\rm t}{\rm i}{\rm o}{\rm n}}^{}&=ad{\widehat{F}}_{\theta }\ {\widehat{H}}_{\theta }\ =
{\widehat{F}}_{\theta }\ {\widehat{H}}_{\theta }\ -\ {\widehat{H}}_{\theta }\ {\widehat{F}}_{\theta }\ \nonumber \\
 &=\widehat{\left\langle{\left({{F}_{\theta },{f}_{\theta }}\right),\left({{H}_{\theta },{h}_{\theta }}\right)}\right\rangle}\ \ \ \ \ \ \ \ \ \leftarrow \ \ \ \Eq{liebrafpp1}\ {\rm i}{\rm m}{\rm p}{\rm l}{\rm e}{\rm m}{\rm e}{\rm n}{\rm t}{\rm e}{\rm d} ~{\rm i}{\rm n}~{\rm F}{\rm P}{\rm P}~~\label{eq:addragt}\end{align}




In \Eq{finff}, the Lie bracket must be the Lie bracket including the quaternion operator. The normal form proceeds order by order as in any perturbative scheme--- spin or no spin.

In FPP, \Eq{finff} is performed by a call to a subroutine: 

\begin{code}
       call exp_vector_field_fourier(F_theta,H_theta,H_theta)   
\end{code}

It makes sense to call the entire operation of \Eq{finff} an ``exponential'' since this equation is derived by ``extending state space'' to include $\theta $ as a state variable. In that case, the normal exponential of a Lie map applies. 


\subsection{The actual iterative step of the normal form}\label{sec:itenorm}
...
We expand \Eq{finff} and retain the leading order terms in $F_{\theta}$ and  $V_{\theta}$. Here $H_0$ is the orbital vector field and $h_0$ is the quaternion part:
%
%]|Expr|[#b @`b___})1# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|<c!$1(#$^""Symbol^:"&c0  D^q_"#*|:#&c0!*,L$^:"&c0  d^q_}}:!&c0!*,F,]|
%|<c!,Q(#<c!$1(#$^:#F^:"&c0  q_:#&c0!*,L$^f^:"&c0  q_}}:#&c0!*,L|
%|<c!$1(#$^H^0_,L$^h^0_}}}},K<c!$1(#$^V^:"&c0  q_:#&c0!*,L$^v^:"&c0  q|
%|_}}:#&c0!*,K<c!$1(#<2(":"&c0  .V$^:#&c0!*F^:"&c0  q_}(".Vq}}:#&c0!*,L|
%|<2(":"&c0  .V$^:#&c0!*f^:"&c0  q_}(".Vq}}}}:#&c0!*:! : ;8/<:#;bP8eq|
%|,Zlieepand: ;8/=;bP8-;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} \left({{\Delta }_{\theta },{\delta }_{\theta }}\right)&=\left\langle{\left({{F}_{\theta },{f}_{\theta }}\right),\left({{H}_{0},{h}_{0}}\right)}\right\rangle+\left({{V}_{\theta },{v}_{\theta }}\right)+\left({{\partial {F}_{\theta } \over \partial \theta },{\partial {f}_{\theta } \over \partial \theta }}\right) \label{eq:lieepand}\end{align}
%
%
...
%
%]|Expr|[#b @`b___});# b'4" Chicago^: ;bP8&c0!*.["!Helvetica|:! |
%|$^""*|:"F^"#Symbol^:#&c0  q_:!&c0!*,F,]<c!$1)## b'4$^:"F^:#&c0  q|
%|^:"&c0!*1,L$^F^:#&c0  q^:"&c0!*2}& b!( b"0 b#8 b$@ b%H b&P!WW}}|
%|"$Monaco^:$      $^:"F^:#&c0  q(#:"&c0!*1,L2},]<c%#D(#$^F(%m,L|
%|n,Lk}(#1,L2}$^z^1^m$^z^2^n}(":!-<sum}(%:"m,Ln,Lk}_}:!-<exp<c!$1|
%|(":"ik:#&c0  q}}&c0!* :!-<-<:# $^:"f^:#&c0  q_:!&c0!*,F,]<c%#D|
%|($$^:"f(%m,Ln,Lk}^'b!L$^z^1^m$^z^2^n$^e_("ik:#&c0  q}}(":!&c0!*-<|
%|sum}(-:"m,Ln,Lk,L'b!L,],M1,L0,L1}_} $^e^'b!L_:! : .K|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{subequations}\begin{align} {F}_{\theta }&=\left({{F}_{\theta }^{1},{F}_{\theta }^{2}}\right)~~~~~~{F}_{\theta }^{1,2}=
\sum\limits_{m,n,k}^{} {F}_{m,n,k}^{1,2}{z}_{1}^{m}{z}_{2}^{n}\exp\left({ik\theta }\right) \\ {f}_{\theta }&=\sum\limits_{m,n,k,\ell=
-1,0,1}^{} {f}_{m,n,k}^{\ell}{z}_{1}^{m}{z}_{2}^{n}{e}^{ik\theta }\ {e}_{\ell} \end{align}\end{subequations}
...
%
%]|Expr|[#b @`b___})b!&# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|""Monaco^:"if       $^"#*|:#q^i_:!,F,]$^"$Symbol^:$&c0  e(!:#&c0!*ijk}|
%|_$^q^j_$^q^k_   : ;bP;/":!;bP8,F:"then we define $^"%Times|:%e|
%|^i_:",Gs as: ;bP;/":!;bP8 $^e^1_,F,]<2^1^2}<c!$1($$^q^1_,Ki$^|
%|q^3_}}: ;bP;/":!;bP8  $^e^0_,F,] $^q^2_ ,H,]j,I:% : ;bP;/":!;bP8 |
%|$^e(",M1}_,F,]<2^1^2}<c!$1($$^q^1_,Mi$^q^3_}}  : ;bP;/":!;bP8 |
%|,F: ;bP;/":!;bP8 :"then :!,F:"  [#! (1<c$5Q^:!j}$^e^1_,]-<hphantom|
%|-[0-]$^e^1_$^q^2_,M$^q^2_$^e^1_,],Mi$^e^1_}(1<c$5Q^j}$^e^0_,]|
%|0-<hphantom-[$^e^1_$^q^2_,M$^q^2_$^e^1_,],Mi$^e^0_-]}(.<c$5Q^|
%|j}$^e(",M1}_,]i$^e(",M1}_-<hphantom-[,M$^q^2_$^e^1_,],Mi$^e("|
%|,M1}_-]}} : -;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {\rm i}{\rm f}~~~~~~~{q}_{i}&={\varepsilon }_{ijk}{q}_{j}{q}_{k}\ \ \ \nonumber \\
&{\rm t}{\rm h}{\rm e}{\rm n}~{\rm w}{\rm e}~{\rm d} {\rm e}{\rm f}{\rm i}{\rm n}{\rm e}~{e}_{i}'{\rm s}~{\rm a}{\rm s}\nonumber \\
 {e}_{1}&={1 \over 2}\left({{q}_{1}+i{q}_{3}}\right)\nonumber \\
  {e}_{0}&= {q}_{2} (=j)\ \nonumber \\
 {e}_{-1}&={1 \over 2}\left({{q}_{1}-i{q}_{3}}\right)  \nonumber \\
 &\nonumber \\
 {\rm t}{\rm h}{\rm e}{\rm n}~&~~\begin{array}{c}\widehat{j}{e}_{1}=\hphantom{0}{e}_{1}{q}_{2}-{q}_{2}{e}_{1}=-i{e}_{1}\\
\widehat{j}{e}_{0}=0\hphantom{{e}_{1}{q}_{2}-{q}_{2}{e}_{1}=-i{e}_{0}}\\
\widehat{j}{e}_{-1}=i{e}_{-1}\hphantom{-{q}_{2}{e}_{1}=-i{e}_{-1}}\end{array} \end{align}



We then expand \Eq{eq:lieepand} and separate the orbital and quaternion parts to leading order: 
%
%]|Expr|[#b @`b___})b J# b'4" Chicago^: ;bP8&c0!*.["!Helvetica|:! |
%|$^""Symbol^:"&c0  D^q_:!&c0!*,F,]<c!,Q(#$^F^:"&c0  q_"#*|:#&c0!*,L|
%|$^H^0_}},M<2(#:"&c0  .V, $^:!&c0!*F^:"&c0  q_}(".Vq}}:#&c0!* |
%|,K $^V^:"&c0  q_&c0!* : ;8/<:#;bP8eq,ZwhatisF: ;8/=:!;bP8-<-<|
%|:" :! $^:"&c0  d^q_:!&c0!*,F,]$^h^0_$^f^:"&c0  q_:#&c0!*,M$^:!f|
%|^:"&c0  q_$^:!&c0!*h^0_,M$^H^0_:"&c0  /7/1$^:#&c0!*f^:"&c0  q|
%|_:#&c0!* ,K<c%"C^<cY A(% $^F^:"&c0  q_/7/1$^:#&c0!*h^0_}}(",]|
%|0}_} : ;8/<:#;bP8eq,Zwhatisf: ;8/=;bP8.K|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{subequations}\begin{align} {\Delta }_{\theta }&=\left\langle{{F}_{\theta },{H}_{0}}\right\rangle-{\partial {F}_{\theta } \over \partial \theta }\ +\ {V}_{\theta } \label{eq:whatisF}\\  {\delta }_{\theta }&={h}_{0}{f}_{\theta }-{f}_{\theta }{h}_{0}-{H}_{0}\cdot \nabla {f}_{\theta }\ +\underbrace{\ {F}_{\theta }\cdot \nabla {h}_{0}}\limits_{=
0}^{}\ \label{eq:whatisf}\end{align}\end{subequations}

We now set the orbital part ${\Delta }_{\theta }$ and spin part   ${\delta }_{\theta }$  to zero and later in \sref{sec:normtypes} discuss whether or not that was foolish. Using \Eq{eq:whatisF} we get:

%
%]|Expr|[#b @`b___})=# b'4" Chicago^: ;bP8&c0!*.["!Helvetica|:! |
%|$^""*|:"F(%m,Ln,Lk}(#1,L2}:!,F,] <2(",M$^:"V(%m,Ln,Lk}(#1,L2}}|
%|(*,Mik,Ki<c!$1(&m,Mn,K $^<c!$1(",M1}}_(#1,L2}}}$^"#Symbol^:#&c0  n|
%|^:"&c0!*1_,K<2^1("2:#&c0  p}}<c!$1(%:"&c0!*m,Kn,K1}}$^:#&c0  a|
%|^:"&c0!*1_}}  : ;8/<:";bP8eq,ZthatisF: ;8/=:#;bP8 :!-<-<:# $^|
%|:"f(%m,Ln,Lk}^'b!L:!,F,] <2(",M$^:"v(%m,Ln,Lk}^'b!L}(-,Mik,Ki|
%|<c!$1(#m,Mn}}$^:#&c0  n^:"&c0!*1_,K<c!$1(#m,Kn}}<2^$^:#&c0  a|
%|^:"&c0!*1_("2:#&c0  p}}:"&c0!*,Mi'b!L:#&c0  n}}:"&c0!*  : ;8/<|
%|:";bP8eq,Zthatisf: ;8/=:!;bP8 : .K}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{subequations}\begin{align} {F}_{m,n,k}^{1,2}&= {-{V}_{m,n,k}^{1,2} \over -ik+i\left({m-n+\ {\left({-1}\right)}^{1,2}}\right){\nu }_{1}+{1 \over 2\pi }\left({m+n+1}\right){\alpha }_{1}}\ \ \label{eq:thatisF} \\ {f}_{m,n,k}^{\ell}&= {-{v}_{m,n,k}^{\ell} \over -ik+i\left({m-n}\right){\nu }_{1}+\left({m+n}\right){{\alpha }_{1} \over 2\pi }-i\ell\nu }\ \ \label{eq:thatisf} \end{align}\end{subequations}
...
%
%]|Expr|[#b @`b___})=# b'4" Chicago^: ;bP8&c0!*.["!Helvetica|:! |
%|$^""*|:"F(%m,Ln,Lk}^j:!,F,] <2(",M$^:"V(%m,Ln,Lk}^j}($,Mik,K<c%#D|
%|('i<c!$1(&$^m^j_,M$^n^j_,K $^<c!$1(",M1}}_^j}}$^"#Symbol^:#&c0  n|
%|^:"&c0!*j_,K<2^1("2:#&c0  p}}<c!$1(%$^:"&c0!*m^j_,K$^n^j_,K1}}|
%|$^:#&c0  a^:"&c0!*j_}(":!-<sum}(%:"j,]1,LN}_}}}  : ;8/<:";bP8eq|
%|,ZthatisFn: ;8/=:#;bP8 :!-<-<:# $^:"f(%m,Ln,Lk}^'b!L:!,F,] <2|
%|(",M$^:"v(%m,Ln,Lk}^'b!L}((,Mik,Mi'b!L:#&c0  n:"&c0!*,K<c%#D^|
%|<c!(A(&i<c!$1(#$^m^j_,M$^n^j_}}$^:#&c0  n^:"&c0!*j_,K<c!$1(#$|
%|^m^j_,K$^n^j_}}<2^$^:#&c0  a^:"&c0!*j_("2:#&c0  p}}}}(":!&c0!*-<|
%|sum}(%:"j,]1,LN}_}}}  : ;8/<:";bP8eq,Zthatisfn: ;8/=:!;bP8 : .K|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{subequations}\begin{align} {F}_{m,n,k}^{j}&= {-{V}_{m,n,k}^{j} \over -ik+\sum\limits_{j=
1,N}^{} i\left({{m}_{j}-{n}_{j}+\ {\left({-1}\right)}^{j}}\right){\nu }_{j}+{1 \over 2\pi }\left({{m}_{j}+{n}_{j}+1}\right){\alpha }_{j}}\ \ \label{eq:thatisFn} \\ {f}_{m,n,k}^{\ell}&= {-{v}_{m,n,k}^{\ell} \over -ik-i\ell\nu +\sum\limits_{j=
1,N}^{} \left\{{i\left({{m}_{j}-{n}_{j}}\right){\nu }_{j}+\left({{m}_{j}+{n}_{j}}\right){{\alpha }_{j} \over 2\pi }}\right\}}\ \ \label{eq:thatisfn} \end{align}\end{subequations}

\subsection{Types of normal forms}\label{sec:normtypes}
...
\subsubsection{Rotation and sink }\label{sec:normtypes}

In \Eq{eq:thatisFn}, we notice that if 
%
%]|Expr|[#b @`b___})6# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|""*|:"k,]0"#Monaco^:# and $^"$Symbol^:$&c0  a^:"&c0!*j_,]0 <c%#D|
%|(" <c!1!(&$^m^j_,M$^n^j_,K $^<c!$1(",M1}}_^j}}}(":!-<sum}(%:"j|
%|,]1,LN}_},]0:! : ;8/<:";bP8eq,Ztuneshiftc: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} k=
0~{\rm a}{\rm n}{\rm d} ~{\alpha }_{j}=
0\ \sum\limits_{j=
1,N}^{} \ \left|{{m}_{j}-{n}_{j}+\ {\left({-1}\right)}^{j}}\right|=
0 \label{eq:tuneshiftc}\end{align}
...
If damping is present, one can remove {\bf everything} and the normal form is simply $H_0$--- a sink.  Whether or not this is a good thing to do is a matter of discussion. If there are resonances or large amount of damping (Van der Pol oscillator for example), we may want to keep tune shift and amplitude dependent terms in the Hamiltonian.   

In the case of the quaternions, if
 %
%]|Expr|[#b @`b___})8# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|'b!L,]""*|:"k,]0"#Monaco^:# and $^"$Symbol^:$&c0  a^:"&c0!*j_|
%|,]0 <c%#D(" <c!1!(#$^m^j_,M$^n^j_}}}(":!-<sum}(%:"j,]1,LN}_},]|
%|0:! : ;8/<:";bP8eq,Ztuneshiftq: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} \ell=k=
0~{\rm a}{\rm n}{\rm d} ~{\alpha }_{j}=
0\ \sum\limits_{j=
1,N}^{} \ \left|{{m}_{j}-{n}_{j}}\right|=
0 \label{eq:tuneshiftq}\end{align}
%
then the quaternion Hamiltonian is proportinal to   $e_0= j$ and the coefficient of proportionality depends on the invariants of the transverse plane.

\subsubsection{One-resonance orbital: simple case to illustrate}\label{sec:normorbit}

Let us assume that the tune is dangerously close to  a third order resonance:
%
%]|Expr|[#b @`b___})+# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|""*|:"3$^"#Symbol^:#&c0  n^:"&c0!*1_,]p,K : e:! : -;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} 3{\nu }_{1}=
p+\ \epsilon  \end{align}
where 
$\epsilon $ is a small number.  Then, we have:
%
%]|Expr|[#b @`b___})b K# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%| ""Monaco^:"if  "#Times|:#k,]p:"     $^"$*|:$F(%m,Ln,Lk}^j:!,F,]|
%| <2(",M$^:$V(%m,Ln,Lk}^j}($,Mik,K<c%#D(&i<c!$1(#p,K: e}}:$,K<2|
%|^1("2"%Symbol^:%&c0  p}}<c!$1(%$^:$&c0!*m^j_,K$^n^j_,K1}}$^:%&c0  a|
%|^:$&c0!*j_}(":!-<sum}(%:$j,]1,LN}_}}} : ;bP;/":!;bP8,F<c%"C^<cY A|
%|^:$,]}(%if k,]p}_} :! <2(",M$^:$V(%m,Ln,Lk}^j}($i: e:$,K<c%#D|
%|(#<2^1("2:%&c0  p}}<c!$1(%$^:$&c0!*m^j_,K$^n^j_,K1}}$^:%&c0  a|
%|^:$&c0!*j_}(":!-<sum}(%:$j,]1,LN}_}}} ,] :!-<mbox-[-<LARGE ,D|
%|:$big:!,D-] : ;8/<:$;bP8eq,Zrest: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align}  {\rm i}{\rm f}~~k=
p~~~~~{F}_{m,n,k}^{j}&= {-{V}_{m,n,k}^{j} \over -ik+\sum\limits_{j=
1,N}^{} i\left({p+\epsilon }\right)+{1 \over 2\pi }\left({{m}_{j}+{n}_{j}+1}\right){\alpha }_{j}}\ \nonumber \\
&\underbrace{=
}\limits_{if\ k=
p}^{}\  {-{V}_{m,n,k}^{j} \over i\epsilon +\sum\limits_{j=
1,N}^{} {1 \over 2\pi }\left({{m}_{j}+{n}_{j}+1}\right){\alpha }_{j}}\ =
\ \mbox{\LARGE $big$} \label{eq:rest}\end{align}


Thefore we leave the resonant  term in the Hamiltonian and do not attempt the inversion of \Eq{eq:rest}. The resulting normalized Hamiltonian operator has the form:    
%
%]|Expr|[#b @`b___})b R# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$^<c$5Q^""*|:"K}^"#Symbol^:#&c0  q_:!&c0!*,F,] <c%#D(%$^:#&c0  n|
%|^:"&c0!*a_,H<c$%!^J},I<2(':#&c0  .V:!&c0!*-<hphantom-[$^:#&c0  F|
%|^:"&c0!*a_:!-]}(":#&c0  .V$^F^:"&c0!*a_}}}(":!-<sum}(%:"a,]1,L|
%|3}_} ,K<2^1^2}$^:#&c0  n(!"$Monaco^:$&c0!*spin}_:",H<c$%!^J},I|
%| <c$5Q^j}  : ;bP;/":!;bP8 ,F:",K ,ZV,H<c$%!^J},I:!-<exp<c!$1(#|
%|i <c!(A(%p:#&c0  q:"&c0!*,M3$^:#&c0  F^:"&c0!*1_}}}},Z ,K ,Z<c$%A|
%|^V},H<c$%!^J},I:!-<exp<c!$1($:",M:!i <c!(A(%p:#&c0  q:"&c0!*,M|
%|3$^:#&c0  F^:"&c0!*1_}}}},Z : ;8/<:";bP8eq,Zoneresh: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {\widehat{K}}_{\theta }&= \sum\limits_{a=
1,3}^{} {\nu }_{a}(\vec{J}){\partial \hphantom{{\Phi }_{a}} \over \partial {\Phi }_{a}}\ +{1 \over 2}{\nu }_{{\rm s}{\rm p}{\rm i}{\rm n}}(\vec{J})\ \widehat{j}\ \ \nonumber \\
 &+\ :V(\vec{J})\exp\left({i \left\{{p\theta -3{\Phi }_{1}}\right\}}\right):\ +\ :\overline{V}(\vec{J})\exp\left({-i \left\{{p\theta -3{\Phi }_{1}}\right\}}\right):\ \label{eq:oneresh}\end{align}
%
...
%
%]|Expr|[#b @`b___})4# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|: B:!,F,] -<exp<c!$1(%: ,Z""*|:",M"#Symbol^:#&c0  aq$^:"&c0!*J|
%|^1_: ,Z}}:",]:!-<exp<c!$1($: ,Z:#&c0  aq<2(&.V:!&c0!*-<hphantom|
%|-[$^:#&c0  F^:"&c0!*1_:!-]}(":#&c0  .V$^F^:"&c0!*1_}}: ,Z}}:" |
%|: ;8/<:";bP8eq,Zcomov: ;8/=:!;bP8 : -;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {\cal B}&= \exp\left({\dragt
-\alpha \theta {J}_{1}\dragt
}\right)=
\exp\left({\dragt
\alpha \theta {\partial \hphantom{{\Phi }_{1}} \over \partial {\Phi }_{1}}\dragt
}\right)\ \label{eq:comov} \end{align}


We then use  \Eq{finff} to compute the effect of $\cal B$ on the Hamiltonian of \Eq{eq:oneresh}:
%
%]|Expr|[#b @`b___})b W# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$(": B<c$5Q^""*|:"K}}^"#Symbol^:#&c0  q_:!&c0!*,F,] <c%#D(%$^|
%|:#&c0  n^:"&c0!*a_,H<c$%!^J},I<2(':#&c0  .V:!&c0!*-<hphantom-[|
%|$^:#&c0  F^:"&c0!*a_:!-]}(":#&c0  .V$^F^:"&c0!*a_}}}(":!-<sum}|
%|(%:"a,]1,L3}_} ,K<2^1^2}$^:#&c0  n(!"$Monaco^:$&c0!*spin}_:",H|
%|<c$%!^J},I <c$5Q^j}  : ;bP;/":!;bP8 ,F:",K ,ZV,H<c$%!^J},I:!-<|
%|exp<c!$1(#i <c!(A(%p:#&c0  q:"&c0!*,M3<c!$1(#$^:#&c0  F^:"&c0!*1|
%|_,K:#&c0  aq}}}}}}:"&c0!*,Z ,K ,Z<c$%A^V},H<c$%!^J},I:!-<exp<c!$1|
%|($:",M:!i <c!(A(%p:#&c0  q:"&c0!*,M3<c!$1(#$^:#&c0  F^:"&c0!*1|
%|_,K:#&c0  aq}}}}}}:"&c0!*,Z : ;bP;/":!;bP8 ,F:",M<c%#D("<2^$($|
%|: ,Z:#&c0  aq<2(&.V:!&c0!*-<hphantom-[$^:#&c0  F^:"&c0!*1_:!-]}|
%|(":#&c0  .V$^F^:"&c0!*1_}}: ,Z}_(#:"n,M1}("n,A}}<2(%:#&c0  .V|
%|:"&c0!*,Z:#&c0  aq<2(&.V:!&c0!*-<hphantom-[$^:#&c0  F^:"&c0!*1|
%|_:!-]}(":#&c0  .V$^F^:"&c0!*1_}},Z}(":#&c0  .Vq}}}(":!&c0!*-<|
%|sum}(#:"n,]1}^:#&c0  .E}: ;8&c0!*/<:";bP8eq,Zoneresh: ;8/=;bP8-;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {{\cal B}\widehat{K}}_{\theta }&= \sum\limits_{a=
1,3}^{} {\nu }_{a}(\vec{J}){\partial \hphantom{{\Phi }_{a}} \over \partial {\Phi }_{a}}\ +{1 \over 2}{\nu }_{{\rm s}{\rm p}{\rm i}{\rm n}}(\vec{J})\ \widehat{j}\ \ \nonumber \\
 &+\ :V(\vec{J})\exp\left({i \left\{{p\theta -3\left({{\Phi }_{1}+\alpha \theta }\right)}\right\}}\right):\ +\ :\overline{V}(\vec{J})\exp\left({-i \left\{{p\theta -3\left({{\Phi }_{1}+\alpha \theta }\right)}\right\}}\right):\ \nonumber \\
 &-\sum\limits_{n=
1}^{\infty } {{\dragt
\alpha \theta {\partial \hphantom{{\Phi }_{1}} \over \partial {\Phi }_{1}}\dragt
}^{n-1} \over n!}{\partial :\alpha \theta {\partial \hphantom{{\Phi }_{1}} \over \partial {\Phi }_{1}}: \over \partial \theta }\label{eq:oneresh}\end{align}


We choose $\alpha $ to get rid of the $\theta $ (time) dependence. Clearly the result is:
%
%]|Expr|[#b @`b___}))# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|""Symbol^:"&c0  a:!&c0!*,F,]p,O3 : -;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} \alpha &=p/3 \end{align}

As for the last term in the transformation, only the derivative survives since the higher order terms commute  with $\partial \hphantom{ \Phi} \over \partial {\Phi }_1$. Therefore the final result is:\
% 
%]|Expr|[#b @`b___})b V# b'4" Chicago^: ;bP8&c0!*-="!Helvetica|:! |
%|$(": B<c$5Q^""*|:"K}}^"#Symbol^:#&c0  q_:!&c0!*,F,] <c%#D(%$^|
%|:#&c0  n^:"&c0!*a_,H<c$%!^J},I<2(&:#&c0  .V:!&c0!*-<hphantom-[|
%|$^:#&c0  F^:"&c0!*a_:!-]}(":#&c0  .V$^F^:"&c0!*a_}}}(":!-<sum}|
%|(%:"a,]1,L3}_} ,K<2^1^2}$^:#&c0  n(!"$Monaco^:$&c0!*spin}_:",H|
%|<c$%!^J},I <c$5Q^j}  : ;bP;/":!;bP8 ,F:",K ,ZV,H<c$%!^J},I:!-<|
%|exp<c!$1($:",Mi:!3$^:#&c0  F^:"&c0!*1_}},Z ,K ,Z<c$%A^V},H<c$%!|
%|^J},I:!-<exp<c!$1(#i3$^:#&c0  F^:"&c0!*1_}},Z ,M<2^p^3}<2(&:#&c0  .V|
%|:!&c0!*-<hphantom-[$^:#&c0  F^:"&c0!*1_:!-]}(":#&c0  .V$^F^:"&c0!*1|
%|_}}: ;8/<:";bP8eq,Zonereshc: ;8/=:!;bP8 : -;|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {{\cal B}\widehat{K}}_{\theta }&= \sum\limits_{a=
1,3}^{} {\nu }_{a}(\vec{J}){\partial \hphantom{{\Phi }_{a}} \over \partial {\Phi }_{a}}\ +{1 \over 2}{\nu }_{{\rm s}{\rm p}{\rm i}{\rm n}}(\vec{J})\ \widehat{j}\ \ \nonumber \\
 &+\ :V(\vec{J})\exp\left({-i3{\Phi }_{1}}\right):\ +\ :\overline{V}(\vec{J})\exp\left({i3{\Phi }_{1}}\right):\ -{p \over 3}{\partial \hphantom{{\Phi }_{1}} \over \partial {\Phi }_{1}}\label{eq:onereshc} \end{align}
...
%|$(": B<c$5Q^""*|:"K}}^"#Symbol^:#&c0  q_:!&c0!*,F,]<c!(A(#:#&c0  n|
%|:"&c0!*,K<c%"C^<cY A($$^:#&c0  D^:"&c0!*1_,H<c$%!^J},I}})%# b'4|
%|$^:#&c0  n^:"&c0!*1_,H<c$%!^J},I,M:#&c0  n|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}_}}}<2(&.V:!&c0!*-<hphantom-[$^|
%|:#&c0  F^:"&c0!*1_:!-]}(":#&c0  .V$^F^:"&c0!*1_}},K<c%#D(%$^:#&c0  n|
%|^:"&c0!*a_,H<c$%!^J},I<2(&:#&c0  .V:!&c0!*-<hphantom-[$^:#&c0  F|
%|^:"&c0!*a_:!-]}(":#&c0  .V$^F^:"&c0!*a_}}}(":!-<sum}(%:"a,]2,L|
%|3}_} ,K<2^1^2}$^:#&c0  n(!"$Monaco^:$&c0!*spin}_:",H<c$%!^J},I|
%| <c$5Q^j}  : ;bP;/":!;bP8 ,F:",K ,ZV,H<c$%!^J},I:!-<exp<c!$1($|
%|:",Mi:!3$^:#&c0  F^:"&c0!*1_}},Z ,K ,Z<c$%A^V},H<c$%!^J},I:!-<|
%|exp<c!$1(#i3$^:#&c0  F^:"&c0!*1_}},Z ,M<2^p^3}<2(&:#&c0  .V:!&c0!*-<|
%|hphantom-[$^:#&c0  F^:"&c0!*1_:!-]}(":#&c0  .V$^F^:"&c0!*1_}}|
%|: ;bP;/":!;bP8 ,F,]<c!(A)## b'4<c%"C^<cY A^<2^: e^:"3}}(%:#&c0  n|
%|:"&c0!*,Mp,O3}_},K<c%"C^<cY A($$^:#&c0  D^:"&c0!*1_,H<c$%!^J}|
%|,I}})&# b'4$^:#&c0  n^:"&c0!*1_,H<c$%!^J},I,M:#&c0  n|
%|}& b!( b"0 b#8 b$@ b%H b&P!WW}_}}& b!( b"0 b#8 b$@ b%H b&P!WW}}|
%|<2(&.V:!&c0!*-<hphantom-[$^:#&c0  F^:"&c0!*1_:!-]}(":#&c0  .V|
%|$^F^:"&c0!*1_}},K<c%#D(%$^:#&c0  n^:"&c0!*a_,H<c$%!^J},I<2(&:#&c0  .V|
%|:!&c0!*-<hphantom-[$^:#&c0  F^:"&c0!*a_:!-]}(":#&c0  .V$^F^:"&c0!*a|
%|_}}}(":!-<sum}(%:"a,]2,L3}_} ,K<2^1^2}$^:#&c0  n(!:$&c0!*spin}|
%|_:",H<c$%!^J},I <c$5Q^j}  : ;bP;/":!;bP8 ,F:",K ,ZV,H<c$%!^J}|
%|,I:!-<exp<c!$1($:",Mi:!3$^:#&c0  F^:"&c0!*1_}},Z ,K ,Z<c$%A^V}|
%|,H<c$%!^J},I:!-<exp<c!$1(#i3$^:#&c0  F^:"&c0!*1_}},Z: ;8/<:";bP8eq|
%|,Zonereshcp: ;8/=:!;bP8 : -;}& b!( b"0 b#8 b$@ b%H b&P!WW}]|[
\begin{align} {{\cal B}\widehat{K}}_{\theta }&=\left\{{\nu +\underbrace{{\Delta }_{1}(\vec{J})}\limits_{{\nu }_{1}(\vec{J})-\nu }^{}}\right\}{\partial \hphantom{{\Phi }_{1}} \over \partial {\Phi }_{1}}+\sum\limits_{a=
2,3}^{} {\nu }_{a}(\vec{J}){\partial \hphantom{{\Phi }_{a}} \over \partial {\Phi }_{a}}\ +{1 \over 2}{\nu }_{{\rm s}{\rm p}{\rm i}{\rm n}}(\vec{J})\ \widehat{j}\ \ \nonumber \\
 &+\ :V(\vec{J})\exp\left({-i3{\Phi }_{1}}\right):\ +\ :\overline{V}(\vec{J})\exp\left({i3{\Phi }_{1}}\right):\ -{p \over 3}{\partial \hphantom{{\Phi }_{1}} \over \partial {\Phi }_{1}}\nonumber \\
 &=\left\{{\underbrace{{\epsilon  \over 3}}\limits_{\nu -p/3}^{}+\underbrace{{\Delta }_{1}(\vec{J})}\limits_{{\nu }_{1}(\vec{J})-\nu }^{}}\right\}{\partial \hphantom{{\Phi }_{1}} \over \partial {\Phi }_{1}}+\sum\limits_{a=
2,3}^{} {\nu }_{a}(\vec{J}){\partial \hphantom{{\Phi }_{a}} \over \partial {\Phi }_{a}}\ +{1 \over 2}{\nu }_{{\rm s}{\rm p}{\rm i}{\rm n}}(\vec{J})\ \widehat{j}\ \ \nonumber \\
 &+\ :V(\vec{J})\exp\left({-i3{\Phi }_{1}}\right):\ +\ :\overline{V}(\vec{J})\exp\left({i3{\Phi }_{1}}\right):\label{eq:onereshcp} \end{align}

\Eq{eq:onereshcp} is the final one-resonance normal form in the Hamiltonian frame work. Since it is time independendent it is clear that the following objects are invariants:

\begin{enumerate}
\item Because ${{\cal B}\widehat{K}}_{\theta }$ is $\theta $ indepedent, it is an invariant. 
\item The  actions  in the planes perpendicular to the resonance, commute with  ${{\cal B}\widehat{K}}_{\theta }$ , they  are also invariants.
\end{enumerate}

{\bf  The one-resonance Hamiltonian is not unique. Moreover, the results will always be different from the one-resonance calculation done on a one-turn map. This can be seen on the analytical calculation done in appendix D of reference \cite{suntao}. In a map calculation all the terms proportional to $\cos(3 {{\Phi }_1 })$  are kept. Of course any result expressed in the original variables $x,p_x$ is unique including the invariants in the original space.}
...
\subsubsection{One-resonance spin}\label{sec:normspin}


{\bf \Large \color{h} I need to take a rest and relax before surgery.... so this is blank.}
